...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Alancoin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Alancoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Alancoin-Qt [" + tr("command-line options") + "]                     " + "\n";
